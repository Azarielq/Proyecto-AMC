...
switch ($chartType) {
    ...
    case 'distribucion':
        $details = [
            ['tamaño' => 'Grande', 'total' => 30, 'detalle' => '15 servicios, 15 productos'],
            ['tamaño' => 'Mediana', 'total' => 20, 'detalle' => '10 servicios, 10 productos']
        ];
        break;
    case 'examenes':
        $details = [
    ...
    case 'conversion':
        $details = [
            ['mes' => 1, 'anio' => 2025, 'tasa_conversion' => '75.50', 'detalle' => '50/66 leads convertidos'],
            ['mes' => 2, 'anio' => 2025, 'tasa_conversion' => '80.00', 'detalle' => '60/75 leads convertidos']
        ];
        break;
}
